                    ...
                    <el-row :class="['bdbottom', i1===0?'.bdtop':'', 'vcenter']" v-for="(item1, i1) in scope.row.children" :key="item1.id">
                        ...
                        <el-col :span="19">
                            ...
                            <el-row :class="[i2===0?'':'bdtop', 'vcenter']" v-for="(item2, i2) in item1.children" :key="item2.id">
                                ...
                                <!-- 三级权限 -->
                                <el-col :span="18">
                                    <el-tag type = "warning" v-for="(item3,i3) in item2.children" :key="item3.id" closable @close="removeRightById">{{item3.authName}}</el-tag> <!--eslint-disable-line no-unused-vars-->
                                </el-col>
                            </el-row>
                        </el-col>
                    </el-row>
